...
export class Eagle {
    ...
    static readonly cData : {[category:string] : Eagle.CategoryData} = {
        ...
        Branch             : {isData: false, isGroup: false, isResizable: false, minInputs: 0, maxInputs: 0, minOutputs: 0, maxOutputs: 0, canHaveInputApplication: true, canHaveOutputApplication: false, canHaveExitApplication: false, canHaveParameters: true, icon: "share", color: "#00BDA1"},
