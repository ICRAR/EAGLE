...
export class Eagle {
    ...
    constructor(){
        ...
        Eagle.settings.push(new Setting("Use OAuth to Access GitHub", "Use OAuth instead of Access Token method of interacting with GitHub", Setting.Type.Boolean, Utils.GITHUB_USE_OAUTH, false));
