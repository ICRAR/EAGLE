...
export class Eagle {
    ...
    createConstructFromSelection = () : void => {
        ...
        const constructs : string[] = Utils.buildComponentList((cData: Eagle.CategoryData) => {
            return cData.categoryType === CategoryType.Type.Group;
        });
    ...
    addNodeToLogicalGraph = (node : Node) : void => {
        ...
        if (Eagle.getCategoryData(node.getCategory()).categoryType === CategoryType.Type.Group){
    ...
    editNodeCategory = (eagle: Eagle) : void => {
        ...
        if (this.selectedNode().isData()){
            ...
            eligibleCategories = Utils.getCategoriesWithInputsAndOutputs(this.palettes(), CategoryType.Type.Group, this.selectedNode().getInputPorts().length, this.selectedNode().getOutputPorts().length);
        } else {
