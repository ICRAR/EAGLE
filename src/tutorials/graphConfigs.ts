...
.setType(TutorialStepType.Press)
...
.setWaitType(TutorialStepWait.Modal)
.setType(TutorialStepType.Input)
...
.setType(TutorialStepType.Condition)
...
.setType(TutorialStepType.Condition)
.setWaitType(TutorialStepWait.Element)
.setConditionFunction(function(){return TutorialSystem.isRequestedNodeSelected('HelloWorldApp')})
...
.setWaitType(TutorialStepWait.Delay)
.setDelayAmount(400)
...
.setType(TutorialStepType.Press)
.setPreFunction(function(){ParameterTable.openTable(EagleBottomWindowMode.NodeParameterTable, ParameterTableSelectType.Normal); setTimeout(function(){$('.column_DisplayText button').first().css('visibility','visible')},200)})
.setWaitType(TutorialStepWait.Delay)
.setDelayAmount(700)
.setBackPreFunction(function(){ParameterTable.openTable(EagleBottomWindowMode.NodeParameterTable, ParameterTableSelectType.Normal);})
...
.setType(TutorialStepType.Press)
.setPreFunction(function(){ParameterTable.openTable(EagleBottomWindowMode.NodeParameterTable, ParameterTableSelectType.Normal);})
.setBackSkip(true)
...
.setPreFunction(function(){ParameterTable.openTable(EagleBottomWindowMode.ConfigParameterTable, ParameterTableSelectType.Normal);})
...
.setType(TutorialStepType.Input)
.setPreFunction(function(){ParameterTable.openTable(EagleBottomWindowMode.ConfigParameterTable, ParameterTableSelectType.Normal);})
.setBackPreFunction(function(){ParameterTable.openTable(EagleBottomWindowMode.ConfigParameterTable, ParameterTableSelectType.Normal);})
...
.setPreFunction(function(){ParameterTable.openTable(EagleBottomWindowMode.GraphConfigsTable, ParameterTableSelectType.Normal);})
.setWaitType(TutorialStepWait.Delay)
.setDelayAmount(200)
...
.setDelayAmount(500)
.setAlternateHighlightTargetFunc(function(){return $('#bottomWindow .content')})
.setBackPreFunction(function(){ParameterTable.openTable(EagleBottomWindowMode.GraphConfigsTable, ParameterTableSelectType.Normal);})
