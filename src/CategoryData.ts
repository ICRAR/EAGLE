...
export class CategoryData {
    static readonly cData : {[category:string] : Category.CategoryData} = {
        ...
        GlobalVariable       : {categoryType: Category.Type.Construct, isGroup: false, minInputs: 0, maxInputs: 0, minOutputs: 0, maxOutputs: Number.MAX_SAFE_INTEGER, canHaveComponentParameters: true, canHaveApplicationArguments: false, canHaveConstructParameters: false, icon: "icon-tune", color: Category.Color.Construct, sortOrder: Category.SortOrder.Construct},
