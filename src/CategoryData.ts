...
export class CategoryData {
    static readonly cData : {[category:string] : Category.CategoryData} = {
        ...
        SubGraphReference    : {categoryType: Category.Type.Application, isGroup: false, minInputs: 0, maxInputs: Number.MAX_SAFE_INTEGER, minOutputs: 0, maxOutputs: Number.MAX_SAFE_INTEGER, canHaveComponentParameters: true, canHaveApplicationArguments: true, canHaveConstructParameters: true, icon: "icon-sub_graph_reference", color: Category.Color.Application, radius: EagleConfig.NORMAL_NODE_RADIUS},
