...
export class CategoryData {
    static readonly cData : {[category:string] : Category.CategoryData} = {
        ...
        SubGraphReference    : {categoryType: Category.Type.Construct, isGroup: true, minInputs: 0, maxInputs: 0, minOutputs: 0, maxOutputs: 0, canHaveComponentParameters: true, canHaveApplicationArguments: true, canHaveConstructParameters: true, icon: "icon-sub_graph_reference", color: Category.Color.Construct, radius: EagleConfig.NORMAL_NODE_RADIUS},
