...
function render(graph: LogicalGraph, elementId : string, eagle : Eagle){
    ...
    function mouseEnterPort(port : Field) : void {
        ...
        isDraggingPortValid = Edge.isValid(eagle, null, sourceNode.getKey(), sourcePort.getId(), destinationNode.getKey(), destinationPort.getId(), sourcePort.getType(), false, false, false, true, {errors:[], warnings:[]});
    }
