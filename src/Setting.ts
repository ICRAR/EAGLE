...
const settings : SettingsGroup[] = [
    ...
    new SettingsGroup(
        ...
        [
            ...
            new Setting(true, "Auto-complete edges level", Setting.AUTO_COMPLETE_EDGES_LEVEL, "Specifies the minimum validity level of auto-complete edges displayed when dragging a new edge", false, Setting.Type.Select, Errors.Validity.Valid, Errors.Validity.Valid, Errors.Validity.Warning, Errors.Validity.Warning, Errors.Validity.Invalid, [Errors.Validity.Invalid, Errors.Validity.Warning, Errors.Validity.Valid]),
        ]
    ),
    new SettingsGroup(
        "External Services",
