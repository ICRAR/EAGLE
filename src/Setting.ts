...
const settings : SettingsGroup[] = [
    new SettingsGroup(
        ...
        () => {return true;},
        [
            new Setting(true, "Reset Action Confirmations", Setting.ACTION_CONFIRMATIONS, "Enable all action confirmation prompts", true, Setting.Type.Button, '', '', '', '', '', [], function(){Eagle.getInstance().resetActionConfirmations();}),
            ...
            new Setting(false, "Confirm OJS Format Save", Setting.CONFIRM_OJS_FORMAT, "Prompt user to confirm when saving in the older OJS format, warn that the newer V4 format is recommended.", true, Setting.Type.Boolean, true,true,true,true,true),
