        ...
        if (typeof nodeData.inputPorts !== 'undefined'){
            for (const inputPort of nodeData.inputPorts){
                ...
                if (node.canHaveInputs()){
                    ...
                    errorsWarnings.errors.push(Errors.Message("Node (" + node.getName() + ") not allowed to have input ports. Can add " + port.getIdText()));
                }
            }
        }
        ...
        if (typeof nodeData.outputPorts !== 'undefined'){
            for (const outputPort of nodeData.outputPorts){
                ...
                if (node.canHaveOutputs()){
                    ...
                    errorsWarnings.errors.push(Errors.Message("Node (" + node.getName() + ") not allowed to have output ports. Can add " + port.getIdText()));
                }
            }
        }
