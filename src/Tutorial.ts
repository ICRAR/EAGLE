...
export const tutorialArray = [
    ...
    new Tutorial(
        ...
        [
            ...
            new TutorialStep("User Interface Element Tooltips", "Much of Eagle's interface is iconised. However, you can always hover on the icons to get more information on what they are doing.", TutorialStep.Type.Info, TutorialStep.Wait.None, function () { return $("#navbarSupportedContent .btn-group") }, null, null),
            ...
            new TutorialStep("Graph Options", "This menu allows you to load, save or create graphs", TutorialStep.Type.Info, TutorialStep.Wait.None, function () { return $("#navbarDropdownGraph") }, null, null),
            new TutorialStep("Repositories Tab", "You can browse and load graphs from registered GitHub or GitLab repositories here.", TutorialStep.Type.Info, TutorialStep.Wait.Element, function () { return $("#rightWindowModeRepositories") }, function (eagle) { $('#rightWindowModeRepositories').click(); }, function (eagle) { $('#rightWindowModeRepositories').click(); }),
