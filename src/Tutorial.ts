...
export const tutorialArray = [
    ...
    new Tutorial(
        ...
        [
            ...
            new TutorialStep("Click To Save Settings", "Press 'Ok' to save your changes. You are also able to revert the changes you made by hitting 'cancel'", TutorialStep.Type.Press,Wait.Type.Modal, function(){return $("#settingsModalAffirmativeButton")},function(eagle){eagle.openSettings();$('#settingCategoryExternalServices').click();$('#settingsModalNegativeButton').on('click.tutButtonListener',eagle.tutorial().tutPressStepListener).addClass('tutButtonListener');},function(eagle){eagle.openSettings();$('#settingCategoryExternalServices').click();$('#settingsModalNegativeButton').on('click.tutButtonListener',eagle.tutorial().tutPressStepListener).addClass('tutButtonListener');}),
