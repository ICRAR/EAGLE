...
export const tutorialArray = [
    ...
    new Tutorial(
        ...
        [
            ...
            new TutorialStep("Graph Canvas", "In the graph canvas you can construct the graphs using the components from the palettes in the left Palette Panel.", TutorialStep.Type.Info, TutorialStep.Wait.None, function () { return $("#logicalGraphParent") }, null, null),
            ...
            new TutorialStep("User Interface Element Tooltips", "Much of Eagle's interface is using icons. You can always hover over the icons and most of the other elements to get more information on what they are doing.", TutorialStep.Type.Info, TutorialStep.Wait.None, function () { return $("#navbarSupportedContent .btn-group") }, null, function (eagle) { eagle.closeShortcuts() }),
            ...
            new TutorialStep("Translate Button", "Once configured, you are able to translate the constructed graph quickly by using this button", TutorialStep.Type.Info, TutorialStep.Wait.None, function () { return $("#navDeployBtn") }, function (eagle) { eagle.closeShortcuts() }, null),
            ...
            new TutorialStep("Click To Open Settings", "The settings modal allows to cusomize EAGLE's user experience. By default, EAGLE is simplified by hiding a lot of functionality via the UI modes. To find out more check our <a target='_blank' href='https://eagle-dlg.readthedocs.io/en/master/settings.html#settings'>settings documentation</a>. <b>To continue the tutorial please click the settings button!</b>", TutorialStep.Type.Press, TutorialStep.Wait.None, function () { return $("#settings") }, null, function (eagle) { eagle.closeSettings() }),
