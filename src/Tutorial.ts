...
export const tutorialArray = [
    ...
    new Tutorial(
        ...
        [
            ...
            new TutorialStep("User Interface Element Tooltips", "Much of Eagle's interface is iconised. However, you can always hover over the icons to get more information on what they are doing.", TutorialStep.Type.Info, TutorialStep.Wait.None, function () { return $("#navbarSupportedContent .btn-group") }, null, null),
            ...
            new TutorialStep("Help Menu", "This menu allows you view the various help options", TutorialStep.Type.Info, TutorialStep.Wait.None, function () { return $("#navbarDropdownPalette") }, null, null),
