...
const newTut = TutorialSystem.newTutorial('testTut', 'this is a test tut containing all types of tut steps')
newTut.newTutStep('test step', 'this is a test step', function () { return $("#logicalGraphParent") })
newTut.newTutStep('test step', 'this is a test step', function () { return $("#logicalGraphParent") })