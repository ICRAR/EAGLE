...
export namespace Daliuge {
    ...
    export const graphServiceField = new Field(dummyNode, FieldName.SERVICE as FieldId, FieldName.SERVICE, "", "", "The name of the service hosting the subgraph. Usually GitHub or GitLab", true, Daliuge.DataType.String, false, [Repository.Service.GitHub, Repository.Service.GitLab], false, Daliuge.FieldType.Component, Daliuge.FieldUsage.NoPort);
    export const graphRepositoryField = new Field(dummyNode, FieldName.REPOSITORY as FieldId, FieldName.REPOSITORY, "", "", "The repository containing the subgraph", true, Daliuge.DataType.String, false, [], false, Daliuge.FieldType.Component, Daliuge.FieldUsage.NoPort);
    export const graphBranchField = new Field(dummyNode, FieldName.BRANCH as FieldId, FieldName.BRANCH, "", "", "The branch of the repository containing the subgraph", true, Daliuge.DataType.String, false, [], false, Daliuge.FieldType.Component, Daliuge.FieldUsage.NoPort);
    export const graphCommitField = new Field(dummyNode, FieldName.COMMIT as FieldId, FieldName.COMMIT, "", "", "The commit of the repository containing the subgraph", true, Daliuge.DataType.String, false, [], false, Daliuge.FieldType.Component, Daliuge.FieldUsage.NoPort);
    export const graphPathField = new Field(dummyNode, FieldName.PATH as FieldId, FieldName.PATH, "", "", "The path to the subgraph within the repository", true, Daliuge.DataType.String, false, [], false, Daliuge.FieldType.Component, Daliuge.FieldUsage.NoPort);
