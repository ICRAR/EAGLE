...
export class KeyboardShortcut {
    ...
    static getShortcuts() : KeyboardShortcut[] {
        return [
            ...
            new KeyboardShortcut("new_config", "New config", ["c","ç"], "keydown", KeyboardShortcut.Modifier.Alt, KeyboardShortcut.true, ['create','configs','config'],KeyboardShortcut.allowGraphEditing, KeyboardShortcut.allowPaletteEditing, (eagle): void => {eagle.newConfig();}),
            ...
            new KeyboardShortcut("save_config", "Save Config", ["s", "ß"], "keydown", KeyboardShortcut.Modifier.Alt, KeyboardShortcut.true, ['save', 'config'],KeyboardShortcut.allowGraphEditing, function(eagle){return eagle.logicalGraph().getActiveGraphConfig().getIsModified();}, (eagle): void => {eagle.saveConfig();}),
