...
export class KeyboardShortcut {
    ...
    static getShortcuts() : KeyboardShortcut[] {
        return [
            ...
            new KeyboardShortcut("toggle_right_window", "Toggle right window", [new Key("r")], "keydown", true, false, ['close','open'], KeyboardShortcut.true, KeyboardShortcut.true, KeyboardShortcut.true, (eagle): void => {SideWindow.toggleShown('right')}),
