...
export class KeyboardShortcut {
    ...
    static getShortcuts() : KeyboardShortcut[] {
        return [
            new KeyboardShortcut("quick_action", "Quick Action", [new Key("`")], "keydown", true, true, [''], KeyboardShortcut.true, KeyboardShortcut.true, KeyboardShortcut.quickActionsClosed, (eagle): void => { QuickActions.initiateQuickAction();}),
            ...
            new KeyboardShortcut("save_graph", "Save Graph", [new Key("s")], "keydown", true, false, ['canvas','commit','github','repository','gitlab'], KeyboardShortcut.true, KeyboardShortcut.allowGraphEditing, function(){return KeyboardShortcut.graphNotEmpty && Setting.findValue(Setting.ALLOW_GRAPH_EDITING)}, (eagle): void => {eagle.saveGraph();}),
            new KeyboardShortcut("save_as_graph", "Save Graph As", [new Key("s", KeyboardShortcut.Modifier.Shift)], "keydown", true, false, ['download','canvas'], KeyboardShortcut.true, KeyboardShortcut.allowGraphEditing, function(){return KeyboardShortcut.graphNotEmpty && Setting.findValue(Setting.ALLOW_GRAPH_EDITING)}, (eagle): void => {eagle.saveGraphAs()}),
            new KeyboardShortcut("save_config", "Save Config", [new Key("s", KeyboardShortcut.Modifier.Alt)], "keydown", true, false, ['save', 'config'], KeyboardShortcut.true, KeyboardShortcut.allowGraphEditing, function(eagle){return eagle.logicalGraph().getActiveGraphConfig().getIsModified();}, (eagle): void => {eagle.saveConfig();}),
            ...
            new KeyboardShortcut("delete_selection", "Delete Selection", [new Key("Delete"), new Key("Backspace")], "keydown", true, false, ['remove'], KeyboardShortcut.true, KeyboardShortcut.allowGraphEditing, function(){return KeyboardShortcut.somethingIsSelected && Setting.findValue(Setting.ALLOW_GRAPH_EDITING)}, (eagle): void => {eagle.deleteSelection(false, false, true);}),
            ...
            new KeyboardShortcut("duplicate_selection", "Duplicate Selection", [new Key("d")], "keydown", true, false, ['copy'], KeyboardShortcut.true, KeyboardShortcut.allowGraphEditing, function(){return KeyboardShortcut.somethingIsSelected && Setting.findValue(Setting.ALLOW_GRAPH_EDITING)}, (eagle): void => {eagle.duplicateSelection('normal');}),
            ...
            new KeyboardShortcut("modify_selected_edge","Modify Selected Edge", [new Key("m")], "keydown", true, false, ['edit'], KeyboardShortcut.true, KeyboardShortcut.allowGraphEditing, function(){return KeyboardShortcut.edgeIsSelected && Setting.findValue(Setting.ALLOW_GRAPH_EDITING)}, (eagle): void => {eagle.editSelectedEdge();}),
            ...
            new KeyboardShortcut("toggle_left_window", "Toggle left window", [new Key("l")], "keydown", true, false, ['close','open'], KeyboardShortcut.true, KeyboardShortcut.allowPaletteEditing, function(){return Setting.findValue(Setting.ALLOW_PALETTE_EDITING) || Setting.findValue(Setting.ALLOW_GRAPH_EDITING)}, (eagle): void => {SideWindow.toggleShown(true)}),
            new KeyboardShortcut("toggle_right_window", "Toggle right window", [new Key("r")], "keydown", true, false, ['close','open'], KeyboardShortcut.true, KeyboardShortcut.true, KeyboardShortcut.true, (eagle): void => {SideWindow.toggleShown(false)}),
            new KeyboardShortcut("toggle_both_window", "Toggle both windows", [new Key("b")], "keydown", true, false, ['close','open'], KeyboardShortcut.true, function(){return Setting.findValue(Setting.ALLOW_PALETTE_EDITING) || Setting.findValue(Setting.ALLOW_GRAPH_EDITING)}, function(){return Setting.findValue(Setting.ALLOW_PALETTE_EDITING) || Setting.findValue(Setting.ALLOW_GRAPH_EDITING)}, (eagle): void => {eagle.toggleWindows();}),
            ...
            new KeyboardShortcut("table_move_down", "Table move down one cell", [new Key("Enter")], "keydown", true, true, ['controls'], KeyboardShortcut.true, KeyboardShortcut.false, (eagle): boolean => {return ParameterTable.showTableModal();}, (eagle, event): void => { ParameterTable.tableEnterShortcut(event);}),

            new KeyboardShortcut("open_graph_configurations_table_modal", "Open Graph Configurations Table Modal", [new Key("t", KeyboardShortcut.Modifier.Alt), new Key("t", KeyboardShortcut.Modifier.Ctrl)], "keydown", true, false, ['config','graph','table'], KeyboardShortcut.true, KeyboardShortcut.true, KeyboardShortcut.true, (eagle): void => {GraphConfigurationsTable.openModal();}),
        ];
    }
    ...
    static getQuickActions() : KeyboardShortcut[] {
        return [
            ...
            KeyboardShortcut.QUICK_ACTION("loadFromRepository", "Load From Repository", [], (eagle): void => {SideWindow.setShown(false,true);eagle.changeRightWindowMode(Eagle.RightWindowMode.Repository);}),
