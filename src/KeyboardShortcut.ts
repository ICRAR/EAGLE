...
export class KeyboardShortcut {
    ...
    static getShortcuts() : KeyboardShortcut[] {
        return [
            ...
            new KeyboardShortcut("save_config", "Save Config", ["s"], "keydown", KeyboardShortcut.Modifier.Ctrl, KeyboardShortcut.true, ['canvas','commit','github','repository','gitlab'],KeyboardShortcut.allowGraphEditing, function(eagle){return eagle.logicalGraph().getActiveGraphConfig().getIsModified();}, (eagle): void => {eagle.saveConfig();}),
