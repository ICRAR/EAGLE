...
project = "EAGLE<sup>π"
copyright = "2026, James Strauss, Vitaliy Ogarko, Andreas Wicenec, Lisa Evans, Moritz Wicenec"
...
latex_documents = [
    (master_doc, "EAGLE.tex", "EAGLE Documentation", "ICRAR", "manual"),
]
...
man_pages = [(master_doc, "eagle", "EAGLE Documentation", [author], 1)]
